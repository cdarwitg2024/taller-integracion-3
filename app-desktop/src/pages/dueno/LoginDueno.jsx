...
function LoginDueno({ onLogin, onBack }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error en login de dueño:', err);
      ...
      >
        ...
        >
          <Box>
            ...
            >
              Bienvenido al Panel de Administración. Controla tus catálogos, gestiona el inventario y monitorea las métricas clave de tu cafetería en un solo lugar.
            </Typography>
          </Box>
